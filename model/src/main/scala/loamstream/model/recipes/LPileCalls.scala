...
object LPileCalls {
  ...
  type LCalls2[Call0 <: LPileCall[_, _], Call1 <: LPileCall[_, _]] = LPileCallsNode[Call0, LCalls1[Call1]]
  type LCalls3[Call0 <: LPileCall[_, _], Call1 <: LPileCall[_, _], Call2 <: LPileCall[_, _]] =
  LPileCallsNode[Call0, LCalls2[Call1, Call2]]

  def calls0(): LCalls0 = LPileCallsNil

  def calls1[Call0 <: LPileCall[_, _]](call0: Call0): LCalls1[Call0] =
    LPileCallsNode[Call0, LCalls0](call0, calls0())

  def calls2[Call0 <: LPileCall[_, _], Call1 <: LPileCall[_, _]](call0: Call0, call1: Call1):
  LCalls2[Call0, Call1] =
    LPileCallsNode[Call0, LCalls1[Call1]](call0, calls1(call1))

  def calls3[Call0 <: LPileCall[_, _], Call1 <: LPileCall[_, _],
  Call2 <: LPileCall[_, _]](call0: Call0, call1: Call1, call2: Call2):
  LCalls3[Call0, Call1, Call2] =
    LPileCallsNode[Call0, LCalls2[Call1, Call2]](call0, calls2(call1, call2))
}

trait LPileCalls[Call0 <: LPileCall[_, _], MoreCalls <: LPileCalls[_, _]] {
  def ::[TagNew <: LSigTag, CallNew <: LPileCall[TagNew, _]](callNew: CallNew) =
    LPileCallsNode[CallNew, LPileCalls[Call0, MoreCalls]](callNew, this)
}

object LPileCallsNil extends LPileCalls[Nothing, Nothing]

case class LPileCallsNode[Call0 <: LPileCall[_, _],
