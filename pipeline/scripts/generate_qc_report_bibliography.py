...
def main(args=None):
	...
	with open(args.out,'w') as f:
		...
		f.write("\n"); f.write(r"\bibitem{primus} PRIMUS: Pedigree Reconstruction and Identification of a Maximum Unrelated Set. \url{https://primus.gs.washington.edu/primusweb/}."); f.write("\n")
