...
import loamstream.cwl.ParametrizedBashParser.Token.TokenType
import loamstream.cwl.ParametrizedStringTemplate.{CharElement, Element, ParameterPart}
import loamstream.cwl.ParametrizedBashParser.{ScanMark, Token}
