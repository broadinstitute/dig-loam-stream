...
object HailSupport {
  ...
  implicit final class StringContextWithHail(val stringContext: StringContext) extends AnyVal {
    ...
    def pyhail(
      ...
      val scriptFile = makeScript(stringContext, name, scriptParams, args: _*)
      
      hail"$scriptFile"(name)
    }
    ...
    def hail(
      ...
      LoamCmdTool.StringContextWithCmd(StringContext(newParts: _*)).cmd(newArgs: _*)(name)
    }
  }
}
