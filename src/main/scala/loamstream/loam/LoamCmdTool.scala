...
object LoamCmdTool {
  ...
  implicit final class StringContextWithCmd(val stringContext: StringContext) extends AnyVal {
     ...
     */
    def cmd(args: Any*)(name: String = autoGeneratedName())(implicit scriptContext: LoamScriptContext): LoamCmdTool = {
  ...
  //TODO
  private val nameSequence: Sequence[Int] = Sequence()
...
final case class LoamCmdTool private (
    id: LId, 
    name: String, 
    tokens: Seq[LoamToken])(implicit val scriptContext: LoamScriptContext) extends Tool {
