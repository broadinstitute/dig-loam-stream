...
object LoamSetTag04 {
  def create[K00: TypeTag, K01: TypeTag, K02: TypeTag, K03: TypeTag] =
    LoamSetTag04(typeTag[K00], typeTag[K01], typeTag[K02], typeTag[K03])
}

case class LoamSetTag04[K00, K01, K02, K03](kTag00: TypeTag[K00], kTag01: TypeTag[K01], kTag02: TypeTag[K02],
                                            kTag03: TypeTag[K03])
  extends LoamSetTag with LoamHeapTag04[K00, K01, K02, K03] {
  override def key = LoamKeyTag04[K00, K01, K02, K03](kTag00, kTag01, kTag02, kTag03)
