...
object LPileCalls {
  ...
  type LCalls2[Tag0 <: LPileTag[_, _], Call0 <: LPileCall[Tag0, _, _],
  Tag1 <: LPileTag[_, _], Call1 <: LPileCall[Tag1, _, _]] =
  LPileCallsNode[Tag0, Call0, LCalls1[Tag1, Call1]]
  type LCalls3[Tag0 <: LPileTag[_, _], Call0 <: LPileCall[Tag0, _, _],
  Tag1 <: LPileTag[_, _], Call1 <: LPileCall[Tag1, _, _],
  Tag2 <: LPileTag[_, _], Call2 <: LPileCall[Tag2, _, _]] =
  ...
  def calls2[Tag0 <: LPileTag[_, _], Call0 <: LPileCall[Tag0, _, _],
  Tag1 <: LPileTag[_, _], Call1 <: LPileCall[Tag1, _, _]](call0: Call0, call1: Call1):
  LCalls2[Tag0, Call0, Tag1, Call1] =
    LPileCallsNode[Tag0, Call0, LCalls1[Tag1, Call1]](call0, calls1(call1))

  def calls3[Tag0 <: LPileTag[_, _], Call0 <: LPileCall[Tag0, _, _],
  Tag1 <: LPileTag[_, _], Call1 <: LPileCall[Tag1, _, _],
  Tag2 <: LPileTag[_, _], Call2 <: LPileCall[Tag2, _, _]](call0: Call0, call1: Call1, call2: Call2):
