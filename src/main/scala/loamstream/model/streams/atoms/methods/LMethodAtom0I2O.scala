...
import loamstream.model.streams.atoms.methods.LMethodAtom0I2O.{LSocketO1, LSocketO0}
...
object LMethodAtom0I2O {
  ...
  case class LSocketO0[O0 <: LPileTag, O1 <: LPileTag](method: LMethodAtom0I2O[O0, O1])
    extends LSocket[O0, LMethodTag0I2O[O0, O1], LMethodAtom0I2O[O0, O1]] {
    override def pileTag = method.tag.output0
  }

  case class LSocketO1[O0 <: LPileTag, O1 <: LPileTag](method: LMethodAtom0I2O[O0, O1])
    extends LSocket[O1, LMethodTag0I2O[O0, O1], LMethodAtom0I2O[O0, O1]] {
...
O1 <: LPileTag : TypeTag](id: String, tag: LMethodTag0I2O[O0, O1])
  extends LMethod0I2O[O0, O1, LMethodTag0I2O[O0, O1], LMethodAtom0I2O[O0, O1]] {
  override def output0: LSocket[O0, LMethodTag0I2O[O0, O1], LMethodAtom0I2O[O0, O1]] = LSocketO0(this)
  override def output1: LSocket[O1, LMethodTag0I2O[O0, O1], LMethodAtom0I2O[O0, O1]] = LSocketO1(this)
