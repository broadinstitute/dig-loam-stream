...
object LMethodAtom1I1O {
  ...
  case class LSocketI0[I0 <: LPileTag, O0 <: LPileTag](method: LMethodAtom1I1O[I0, O0])
    extends LSocket[I0, LMethodTag1I1O[I0, O0], LMethodAtom1I1O[I0, O0]] {
    override def pileTag = method.tag.input0
  }

  case class LSocketO0[I0 <: LPileTag, O0 <: LPileTag](method: LMethodAtom1I1O[I0, O0])
    extends LSocket[O0, LMethodTag1I1O[I0, O0], LMethodAtom1I1O[I0, O0]] {
...
O0 <: LPileTag : TypeTag](id: String, tag: LMethodTag1I1O[I0, O0])
  extends LMethod1I1O[I0, O0, LMethodTag1I1O[I0, O0], LMethodAtom1I1O[I0, O0]] {
  override def input0: LSocket[I0, LMethodTag1I1O[I0, O0], LMethodAtom1I1O[I0, O0]] = LSocketI0(this)

  override def output0: LSocket[O0, LMethodTag1I1O[I0, O0], LMethodAtom1I1O[I0, O0]] = LSocketO0(this)
