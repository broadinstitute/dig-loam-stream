...
import loamstream.model.streams.atoms.methods.LMethodAtom2I0O.{LSocketI1, LSocketI0}
...
object LMethodAtom2I0O {
  ...
  case class LSocketI0[I0 <: LPileTag, I1 <: LPileTag](method: LMethodAtom2I0O[I0, I1])
    extends LSocket[I0, LMethodTag2I0O[I0, I1], LMethodAtom2I0O[I0, I1]] {
    override def pileTag = method.tag.input0
  }

  case class LSocketI1[I0 <: LPileTag, I1 <: LPileTag](method: LMethodAtom2I0O[I0, I1])
    extends LSocket[I1, LMethodTag2I0O[I0, I1], LMethodAtom2I0O[I0, I1]] {
...
I1 <: LPileTag : TypeTag](id: String, tag: LMethodTag2I0O[I0, I1])
  extends LMethod2I0O[I0, I1, LMethodTag2I0O[I0, I1], LMethodAtom2I0O[I0, I1]] {
  override def input0: LSocket[I0, LMethodTag2I0O[I0, I1], LMethodAtom2I0O[I0, I1]] = LSocketI0(this)

  override def input1: LSocket[I1, LMethodTag2I0O[I0, I1], LMethodAtom2I0O[I0, I1]] = LSocketI1(this)
