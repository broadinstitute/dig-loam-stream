...
object LMethodAtom2I2O {
  ...
  O1 <: LPileTag](method: LMethodAtom2I2O[I0, I1, O0, O1])
    extends LSocket[I0, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] {
    override def pileTag = method.tag.input0
  }

  case class LSocketI1[I0 <: LPileTag, I1 <: LPileTag, O0 <: LPileTag,
  O1 <: LPileTag](method: LMethodAtom2I2O[I0, I1, O0, O1])
    extends LSocket[I1, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] {
    override def pileTag = method.tag.input1
  }

  case class LSocketO0[I0 <: LPileTag, I1 <: LPileTag, O0 <: LPileTag,
  O1 <: LPileTag](method: LMethodAtom2I2O[I0, I1, O0, O1])
    extends LSocket[O0, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] {
    override def pileTag = method.tag.output0
  }

  case class LSocketO1[I0 <: LPileTag, I1 <: LPileTag, O0 <: LPileTag,
  O1 <: LPileTag](method: LMethodAtom2I2O[I0, I1, O0, O1])
    extends LSocket[O1, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] {
...
O1 <: LPileTag : TypeTag](id: String, tag: LMethodTag2I2O[I0, I1, O0, O1])
  extends LMethod2I2O[I0, I1, O0, O1, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] {
  override def input0: LSocket[I0, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketI0(this)

  override def input1: LSocket[I1, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketI1(this)

  override def output0: LSocket[O0, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketO0(this)

  override def output1: LSocket[O1, LMethodTag2I2O[I0, I1, O0, O1], LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketO1(this)
