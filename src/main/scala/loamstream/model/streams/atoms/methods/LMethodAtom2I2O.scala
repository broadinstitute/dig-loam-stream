...
O1 <: LPileTag : TypeTag](id: String, tag: LMethodTag2I2O[I0, I1, O0, O1])
  ...
  override def input0: LSocket[I0, LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketI0(this)

  override def input1: LSocket[I1, LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketI1(this)

  override def output0: LSocket[O0, LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketO0(this)

  override def output1: LSocket[O1, LMethodAtom2I2O[I0, I1, O0, O1]] = LSocketO1(this)
