...
object Sets {
   ...
   * `--`, hence the need to ensure we have HashSets.  Empirically, using this method makes LoamGraph validation run 
   * in linear time instead of quadratic time, as it did previously.   
   */
